  ...
  },
  {
    ...
    items: [
      ...
      { key: "loads-detail", fixture: "loads-detail", title: "Load detail", status: "fixed",
        changes: ["Values in the two-column field grid were cut with an ellipsis (“27 Sept 20…”, “Per ton — R…”) and only survived in a tooltip. <span class=\"mono\">.field-value</span> now wraps; nothing is hidden.", "Field labels on the corrected grey. Card structure, the summary header and the action bar unchanged."],
  ...
  },
  {
    ...
    items: [
      { key: "campaigns-list-and-detail", fixture: "campaigns-list-and-detail", title: "Campaign list and campaign detail", status: "fixed",
        changes: ["Transactions table at 1280: the eight-column grid was squeezed into a 560px pane, so “Duration” and “Rate”, “Outbound” and “No Answer” read as one word and the date wrapped to four lines. Now a 12px column gap, a 150px floor on Time, a 980px floor on header and body so the table scrolls sideways inside its card, and the section header stays put while scrolling. A guard test pins the ratio string, so the floor rides on the cells rather than the tracks.", "Filter chips, counts and metadata on the corrected grey; the New Campaign button unchanged.", "Tablet and mobile: title clears the menu button. The filter-label alignment in the left column is an open item."],
